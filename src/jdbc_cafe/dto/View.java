...
public class View {
	...
	public View(String crank, String cofcode, String cofname, String cost, String salesnum, String supply,
	...
	public String toString() {
		return String.format(
				"View [crank=%s, cofcode=%s, cofname=%s, cost=%s, salesnum=%s, supply=%s, surtex=%s, price=%s, margin=%s, marginprice=%s]",
